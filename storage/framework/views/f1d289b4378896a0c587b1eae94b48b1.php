...
<div x-data="{
    ...
    <form method="POST" action="<?php echo e(route('songs.store')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>

        <div>
            <label class="block text-sm font-medium mb-1">Song Title</label>
            <input name="title" required value="<?php echo e(old('title')); ?>" placeholder="Tere Baad"
        ...
        <div>
            ...
            <textarea name="description" rows="2" placeholder="A slow emotional Urdu-Hindi romantic song about separation."
                      class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800"><?php echo e(old('description')); ?></textarea>
        </div>

        <div>
            <label class="block text-sm font-medium mb-1">Lyrics (optional — leave blank to auto-generate)</label>
            <textarea name="lyrics" rows="4" class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800"><?php echo e(old('lyrics')); ?></textarea>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input name="genre" required placeholder="90s Bollywood Romantic" value="<?php echo e(old('genre')); ?>"
            ...
            <div>
                ...
                <input name="mood" required placeholder="Sad Romantic" value="<?php echo e(old('mood')); ?>"
                       class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800">
            </div>
            <div>
            ...
            <div>
                ...
                <input name="voice_style" placeholder="Classic playback singer" value="<?php echo e(old('voice_style')); ?>"
                       class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800">
            </div>
            <div>
                <label class="block text-sm font-medium mb-1">Tempo (BPM)</label>
                <input type="number" name="tempo_bpm" min="40" max="220" placeholder="82" value="<?php echo e(old('tempo_bpm')); ?>"
                       class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="flex flex-wrap gap-2">
                <?php $__currentLoopData = ['Harmonium','Sarangi','Tabla','Dholak','Acoustic Guitar','Sitar','Flute','Strings']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button type="button" @click="toggleInstrument('<?php echo e($inst); ?>')"
                            :class="instruments.includes('<?php echo e($inst); ?>') ? 'bg-indigo-600 text-white' : 'bg-gray-100 dark:bg-gray-800'"
        ...
        <div>
            ...
            <input type="number" name="duration" min="15" max="360" value="<?php echo e(old('duration', 180)); ?>"
                   class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800">
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel project\ai-song-studio\resources\views/songs/create.blade.php ENDPATH**/ ?>